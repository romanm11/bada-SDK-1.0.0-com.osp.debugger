...
public class SimulArgumentsTab extends CLaunchConfigurationTab {
    ...
    group.setLayoutData(gd);
		...
		group.setText(OspLaunchMessages.getString("CArgumentsTab.C/C++_Program_Arguments")); //$NON-NLS-1$
		fPrgmArgumentsText = new Text(group, SWT.MULTI | SWT.WRAP | SWT.BORDER | SWT.V_SCROLL);
		fPrgmArgumentsText.getAccessible().addAccessibleListener(
				new AccessibleAdapter() {                       
                    public void getName(AccessibleEvent e) {
                            e.result = OspLaunchMessages.getString("CArgumentsTab.C/C++_Program_Arguments"); //$NON-NLS-1$
                    }
                }
		);
    ...
    fPrgmArgumentsText.setFont(font);
		...
		fArgumentVariablesButton= createPushButton(group, OspLaunchMessages.getString("CArgumentsTab.Variables"), null); //$NON-NLS-1$
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {
		...
		config.setAttribute(ICDTLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, IOspLaunchConfigurationConstants.DEFAULT_SIMUL_ARG);
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		try {
			...
			fPrgmArgumentsText.setText(configuration.getAttribute(ICDTLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, IOspLaunchConfigurationConstants.DEFAULT_SIMUL_ARG)); //$NON-NLS-1$
			
			fWorkingDirectoryBlock.initializeFrom(configuration);
		}
		catch (CoreException e) {
			setErrorMessage(OspLaunchMessages.getFormattedString("Launch.common.Exception_occurred_reading_configuration_EXCEPTION", e.getStatus().getMessage())); //$NON-NLS-1$
	...
	public String getName() {
		return OspLaunchMessages.getString("CArgumentsTab.Arguments"); //$NON-NLS-1$
	}
