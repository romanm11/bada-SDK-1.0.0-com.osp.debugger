 ...
 */
public class SimulatorDebuggerPage extends AbstractCDebuggerPage implements Observer {
	...
	public void setDefaults( ILaunchConfigurationWorkingCopy configuration ) {
		configuration.setAttribute( IMILaunchConfigurationConstants.ATTR_DEBUG_NAME, IDebugConstants.DEBUGGER_SIMUL_DEBUG_NAME_DEFAULT); //$NON-NLS-1$
	...
	public void initializeFrom( ILaunchConfiguration configuration ) {
		...
		String gdbCommand = IDebugConstants.DEBUGGER_SIMUL_DEBUG_NAME_DEFAULT ;
		String gdbInit = IMILaunchConfigurationConstants.DEBUGGER_GDB_INIT_DEFAULT;
		try {
			gdbCommand = configuration.getAttribute( IMILaunchConfigurationConstants.ATTR_DEBUG_NAME, IDebugConstants.DEBUGGER_SIMUL_DEBUG_NAME_DEFAULT ); //$NON-NLS-1$
		}
