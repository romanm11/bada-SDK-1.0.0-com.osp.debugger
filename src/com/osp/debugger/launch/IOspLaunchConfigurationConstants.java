...
public class IOspLaunchConfigurationConstants {
	...
	public static final String BADA_SIMULATOR_ROOT="${SDKROOT}\\Model\\${MODEL_NAME}\\Simulator\\FS\\Win32FS\\Osp\\Applications\\${APPLICATION_ID}";
	public static final String DEFAULT_SUMUAL_CODE_BINARY_PATH = BADA_SIMULATOR_ROOT + "\\bin";
	...
	public static final String DEFAULT_SIMUL_ARG="-s \"${SIMULATOR_LIB_PATH}\\PhoneShell.dll\" -d Generic.dbi";
	public static final boolean DEFAULT_STOP_AT_MAIN=false;
	
	
	public static final String BADA_HOST_TARGET_ROOT="${SDKROOT}\\Temp\\${APPLICATION_ID}";
